...
func LoadEnv(fileEnvName string) error {
	...
	types.Env_min_word_len, _ = strconv.Atoi(os.Getenv("MIN_WORD_LEN"))
	types.Env_max_words, _ = strconv.Atoi(os.Getenv("MAX_WORDS"))
	types.Env_max_words_percentage, _ = strconv.Atoi(os.Getenv("MAX_WORDS_PERCENTAGE"))

	types.Env_timer_fsscan, _ = strconv.Atoi(os.Getenv("TIMER_FSSCAN"))
